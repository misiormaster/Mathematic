...
public class UiDivision extends JFrame {
	...
	public UiDivision() {
		...
		btnEnter.setBounds(110, 530, 230, 55);
		...
		btnBack.setBounds(423, 530, 230, 55);
		...
		btnNext.setBounds(110, 530, 230, 55);
		btnNext.setVisible(false);
		...
		txtInstructions.setText("Witaj! W tej grze możesz zdobyć maksymalnie 20 punktów rozwiązując poprawnie 20 przykładów na dzielenie. Powodzenia !!! :)");
