...
public class UiAddition extends JFrame {
	...
	public UiAddition() {
		...
		btnEnter.setBounds(110, 547, 230, 55);
		...
		btnBack.setBounds(429, 547, 230, 55);
		...
		btnNext.setBounds(110, 547, 230, 55);
		btnNext.setVisible(false);
		...
		txtInstructions.setText("Witaj! W tej grze możesz zdobyć maksymalnie 20 punktów rozwiązując poprawnie 20 przykładów na dodawanie. Powodzenia !!! :)");
